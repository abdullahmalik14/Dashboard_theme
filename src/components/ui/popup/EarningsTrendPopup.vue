<template>
  <TrendPopup :model-value="modelValue" @update:model-value="$emit('update:modelValue', $event)" :period="period"
    @update:period="$emit('update:period', $event)" title="Earnings Insight"
        ...
        <div
          ...
          <div class="flex flex-col justify-center items-center gap-4">
            <template v-if="insightData?.total">
              <div>
                <span class="text-gray-900 text-4xl font-semibold font-['Poppins'] leading-10">{{
          ...
          <div class="flex flex-col justify-center items-center gap-6 h-full text-center">
            ...
            <div class="flex flex-col gap-1">
              <span class="text-base font-medium text-light-text-secondary dark:text-dark-text-secondary">No trend to
                show at
                the moment</span>
              <a href="#" class="text-sm text-light-text-secondary dark:text-dark-text-secondary underline">Learn ways
                to
                earn</a>
            </div>
          </div>
